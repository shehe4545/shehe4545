...
"https://i.imgur.com/ZSlCWrx.png",
    ...
    var ZiaRein2 = () => api.sendMessage({body: `اقتراحي لك للأنمي\n\nانقر على الصورة للحصول على جودة افضل`, attachment: fs.createReadStream(__dirname + "/cache/ZiaRein1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/ZiaRein1.jpg"), event.messageID);
