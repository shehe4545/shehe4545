...
module.exports.run = async function ({ api, event, args, Users, permssion, getText ,Threads}) {
  ...
  const listNDH = NDH || config.NDH ||  [];
  {
    ...
    var link = [
      "https://i.imgur.com/Jh4lvmb.jpg",
      "https://i.imgur.com/JTJvqTC.jpg",
      "https://i.imgur.com/cQxapjW.jpg"
    ];
    ...
    var callback = () => 
      api.sendMessage({ body: `\n•الرتب•\n•••••••••••••••••••••\n• الرتب الادارية •\n • القائد العام \n• إداري\n • كوماندو\n• رتب المملكة•\n• ملك •مسؤول المملكة •\n وزير• مشرف المملكة•\n •نائب وزير\n• مستشار \n• نائب مستشار\n•فارس\n •محارب\n •جندي\n •متدرب \n •مدني •نقطة البداية•\n•••••••••••••••••••••••\n• يعطى الادمن للوزير وأعلى\n•في حالة غياب الوزير يحصل\n النائب على ادمن ويصبح وزير مؤقت\n•يضاف صاحب \nرتبة مستشار واعلى لإدارة المملكة`, attachment: fs.createReadStream(__dirname + "/cache/kensu.jpg"), }, event.threadID, () => fs.unlinkSync(__dirname + "/cache/kensu.jpg"));
