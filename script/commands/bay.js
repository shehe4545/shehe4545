...
if(!isNaN(args[0])) {
        ...
        if (coins > balance) return api.sendMessage('[الاموال] - المبلغ الذي تريد تحويله اكبر من ميزانيتك 💳',threadID,messageID);
          ...
          let path = __dirname + "/cache/bay.png";
    let bg = (await axios.get(`https://i.imgur.com/IENUlaZ.jpg`, {responseType: "arraybuffer" })).data;
